...
/** @class: Application_Model_InputFilter (PHP5-Strict with comments)
...
class RM_Content_Field_Filter {
    ...
    protected $tagBlacklist = array('applet', 'bgsound', 'base', 'basefont', 'embed', 'frame', 'frameset', 'head', 'html', 'id', 'iframe', 'ilayer', 'layer', 'link', 'meta', 'name', 'object', 'script', 'style', 'title', 'xml');
